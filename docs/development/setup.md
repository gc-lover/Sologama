...
#### Основные команды:
- `/design-ability [название]` - Дизайн новой способности
- `/implement-ability [название]` - Реализация способности
- `/create-level [название]` - Создание уровня
- `/balance-ability [название]` - Баланс способности

#### Специфические команды игры:
- `/create-evolution-branch [от] [к]` - Создание ветки эволюции
- `/design-character [тип] [уровень]` - Дизайн персонажа
- `/generate-quest [тип] [уровень]` - Генерация квеста
